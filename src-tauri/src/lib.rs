...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            services::config::get_vrm_fps_mode,
            services::config::set_vrm_fps_mode,
            services::config::get_vrm_view_state,
            services::config::set_vrm_view_state,
            services::config::get_vrm_avatar_state,
            services::config::set_vrm_avatar_state,
            services::config::get_vrm_expression_bindings,
            services::config::set_vrm_expression_bindings,
            services::config::get_vrm_emotion_profile,
            services::config::set_vrm_emotion_profile,
            services::config::get_vrm_hud_layout,
            services::config::set_vrm_hud_layout,
            services::config::get_vrm_mouse_tracking,
            services::config::set_vrm_mouse_tracking,
