...
const ChatMessages = ({
  ...
  return (
    <div
      className="min-h-[var(--chat-list-min-height)] w-full flex-1 overflow-y-auto rounded-xl border border-border/50 bg-muted/50 p-3 pr-2 text-sm leading-relaxed text-foreground/90 [overflow-wrap:anywhere] select-text cursor-text"
