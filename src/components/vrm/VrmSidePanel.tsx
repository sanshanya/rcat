...
export default function VrmSidePanel({ url = DEFAULT_VRM_URL }: VrmSidePanelProps) {
  return (
    <div className="flex shrink-0 items-stretch gap-3">
      <div className="relative w-[var(--vrm-stage-width)] overflow-hidden rounded-2xl border border-border/50 bg-muted/40">
        <VrmCanvas url={url} />
      </div>
      <div className="w-[var(--vrm-debug-width)] rounded-2xl border border-border/50 bg-background/70 p-2 shadow-sm">
